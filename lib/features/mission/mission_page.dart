...
class _RewardTiers extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
      tier('Min. 500 Views', 'No Ads 30 Hari',
...
/// Shortcut card menuju jalur V.I.P (donasi) — alternatif dari mission views.
class _VipShortcutCard extends StatelessWidget {
  const _VipShortcutCard();
              ...
              const Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 2),
                    Text(
                      'Rp 20rb → No Ads 1 bulan · Rp 50rb → No Ads Lifetime (terbatas)',
                      style: TextStyle(
